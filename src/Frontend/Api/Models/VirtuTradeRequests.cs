namespace Frontend.Api.Models
{
    ...
    public record TwoFactorResponse(string? SharedKey, int RecoveryCodesLeft, IEnumerable<string>? RecoveryCodes, bool IsTwoFactorEnabled, bool IsMachineRemembered);
